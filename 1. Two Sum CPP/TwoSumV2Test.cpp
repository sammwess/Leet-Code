...
TEST(TwoSumV2, Nums271115Target9Expects01) {

    std::vector<int> nums = {2, 7, 11, 15};
    int target = 9;

    // Choose implementation to test
    std::unique_ptr<ITwoSum> twoSumImpl = std::make_unique<TwoSumV2>();
...
TEST(TwoSumV2, Nums324Target6Expects12) {
...
TEST(TwoSumV2, Nums33Target6Expects01) {
